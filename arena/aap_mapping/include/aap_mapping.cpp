...
void aap_mapping::inicializer(void)
{
	...
	map_pub = n.advertise<nav_msgs::OccupancyGrid>(map_topic,map_buffer,true);
...
void aap_mapping::startSubscribing(void)
{
	if(multiRobot){
		...
		global_map_sub = n.subscribe<nav_msgs::OccupancyGrid>(global_map_topic , map_buffer, &aap_mapping::globalMapReceived, this);
